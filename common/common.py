...
def parse_args(default=False):
    ...
    parser.add_argument('--dataset', help='Dataset',
                        choices=['cifar10-versus-100', 'WBC', 'dtd', 'cifar10-corruption', 'Tomor_Detection', 'ucsd', 'mvtec-high-var', 'breastmnist', 'head-ct', 'fashion-mnist', 'mnist', 'cifar10', 'cifar100', 'imagenet', 'svhn-10', 'MVTecAD'],
    ...
    parser.add_argument('--model', help='Model',
                        choices=['pretrain-resnet152', 'vit_fitymi', 'vit', 'resnet18', 'resnet18_imagenet', 'pretrain-resnet18'], default="resnet18", type=str)
